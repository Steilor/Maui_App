...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 1103990414, ; hash 0x41cd8e8e, from name: aot-Couteau
		i8 0, ; bool ignore
	...
	%struct.DSOCacheEntry {
		i64 1606128410, ; hash 0x5fbb931a, from name: aot-Couteau.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 208
	...
	%struct.DSOCacheEntry {
		i64 2871656473, ; hash 0xab2a0019, from name: Couteau
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 401
	...
	%struct.DSOCacheEntry {
		i64 3050443905, ; hash 0xb5d21481, from name: libaot-Couteau
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 428
	...
	%struct.DSOCacheEntry {
		i64 3631237600, ; hash 0xd87049e0, from name: Couteau.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 497
	...
	%struct.DSOCacheEntry {
		i64 3699562182, ; hash 0xdc82d6c6, from name: libaot-Couteau.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 509
