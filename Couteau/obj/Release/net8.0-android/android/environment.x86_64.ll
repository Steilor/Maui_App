...
@dso_cache = dso_local local_unnamed_addr global [582 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		i64 303322385933541929, ; hash 0x4359e1a59fe2229, from name: aot-Couteau.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 9
	%struct.DSOCacheEntry {
	...
	%struct.DSOCacheEntry {
		i64 2861623517262614450, ; hash 0x27b6876d6b578fb2, from name: libaot-Couteau
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 83
	...
	%struct.DSOCacheEntry {
		i64 4631448926034721289, ; hash 0x404636427fa9fa09, from name: aot-Couteau
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 143
	...
	%struct.DSOCacheEntry {
		i64 8320268314807293899, ; hash 0x737787f31c06d7cb, from name: Couteau.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 246
	...
	%struct.DSOCacheEntry {
		i64 10528806487134530376, ; hash 0x921dd5b74e7b6b48, from name: libaot-Couteau.dll.so
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 330
	...
	%struct.DSOCacheEntry {
		i64 10894364909225740397, ; hash 0x97308f2a03e1886d, from name: Couteau
		i8 0, ; bool ignore
		ptr @.DSOCacheEntry.7_name, ; name: libaot-Couteau.dll.so
		ptr null; void* handle (0x0)
	}, ; 338
...
@.env.3 = private unnamed_addr constant [37 x i8] c"f0b88e26-ab76-459a-a6ef-e0cd22901967\00", align 16
...
;ApplicationConfig
@.ApplicationConfig.0_android_package_name = private unnamed_addr constant [24 x i8] c"com.companyname.couteau\00", align 16
...
@.DSOCacheEntry.7_name = private unnamed_addr constant [22 x i8] c"libaot-Couteau.dll.so\00", align 16
